...
---
_Software Requirements Engineering for Grid 3D Application_
...
### **Version 1.0 To Be Approved** **Prepared by Ben Tagger** **National Institute for Medical Research** **Mill Hill, LONDON, NW7 1AA** **Created on: 4 [th] March 2005**
...
##### **_1.1 Purpose of the the Product_** **1.1.1 Background to the Project Effort**
...
##### **_1.2 Client, Customer and other Stakeholders_** **1.2.1 The Client**
...
##### **_1.3 The Users of the Product_**
...
##### **_1.4 Requirements Constraints_** **1.4.1 Solution Constraints**
...
##### **_1.5 Naming Conventions and Definitions_**
...
##### **_2.1 The Scope of the Product_** **2.1.1 The Context of the Work**
...
|---|---|---|
|1|Identifier supplies data|Data (in)|
|2|Application returns view/info to identifier|Graphical view (out)|
|3|Investigator supplies data|Data (in)|
|4|Application returns details to investigator|Textual info (out)|
|5|Demonstrator supplies data|Data (in)|
|6|Application provides 3D view|Graphical view (out)|
|7|User requests change of grid orientation|Mouse movement (in)|
|8|User selects multiple points|Mouse and Keyboard (in)|
...
##### **_2.2 Functional and Data Requirements_** **2.2.1 Functional Requirements**
...
|---|---|---|---|---|---|
|Point_Name|X_Value|Y_Value|Z_Value|<number>|<description>|
...
##### **_3.1 Look and Feel Requirements_**
