---
project: Raspberry-Pi-Network-Setup
repository: seanpm2001/Raspberry-Pi-Network-Setup
license: GNU General Public License v3.0
source_file: Learn-Pi/New-Pi/2022/06_June/04/OldVersions/English/USA/README_V1.md
source_url: https://github.com/seanpm2001/Raspberry-Pi-Network-Setup/blob/10e3ee83b4b0f8cd83305d4bf544cea4ceec70fa/Learn-Pi/New-Pi/2022/06_June/04/OldVersions/English/USA/README_V1.md
downloaded_at: 2026-02-04T14:28:33.249860+00:00
consensus_grade_level: 9.7
headings_per_sentence: 0.12
lists_per_sentence: 0.18
smao_sentences_pct: 0.0
vague_words_per_sentence: 0.15
anaphora_per_sentence: 0.73
sentence_cv: 2.769
cpre_terms_per_sentence: 0.15
---
***
...
( [`View yesterdays entry (2022, Friday, June 3rd)`](/Learn-Pi/New-Pi/2022/06_June/03/) | **Today** `2022, Saturday, June 4th` | [`View tomorrows entry (2022, Sunday, June 5th)`](/Learn-Pi/New-Pi/2022/06_June/05/) )
...
| **Day 171** | `2022, Sunday, June 26th` | [Go back](/Learn-Pi/New-Pi/2022/06_June/26/) | **Day 172** | `2022, Monday, June 27th` | [Go back](/Learn-Pi/New-Pi/2022/06_June/27/) |
...
<!-- Notes 2022.03.21
Raspberry Pi day to be Wednesday or Thursday
Still no hyperlink for spill protection tubes
!-->
...
<!-- Notes 2022.04.11
The failed boot on April 11th didn't count
Weekly Raspberry Pi day to be Wednesday or Thursday
Still no hyperlink for spill protection tubes (still can't remember the name)
!-->
...
I kept my Raspberry Pi on all night with no Internet connection again. I continued to briefly use it a little bit to work on the index, and map out what I am going to do next with it. Not much was done with it today.

The Raspberry Pi has been running continuously since 2022 Tuesday April 19th at 8:12 pm. I am going to leave it running until noted otherwise. Just so that I can sleep at night, I turn the monitors off, but not the Pi itself.

I plan to get the files off the Raspberry Pi eventually, but not today.
...
I did not update my Raspberry Pi blog again today, that project went on hiatus.
...
I kept my Raspberry Pi on all night with no Internet connection again. I continued use again today, getting back into audio conversion, while I did GitHub organization work.
...
I kept my Raspberry Pi on all night with no Internet connection again. I continued use again today, but just left the device idle.
...
I kept my Raspberry Pi on all night with no Internet connection again. I continued to leave the device idle today. I have noticed that the right monitor has been flickering four times every hour (a full screen flicker) but has no problems other than that. The other monitor lost HDMI signal at one point, but not the other, I was able to resume easily. There was a power flicker and there was enough reserve power that the Pi didn't go down (note that it does NOT have a backup power generator yet)
...
I kept my Raspberry Pi on all night with no Internet connection again. I continued to leave the device idle today. I have noticed that the right monitor has been flickering four times every hour (a full screen flicker) but has no problems other than that. It was still doing that today. I have noticed smaller flickers on both monitors, and I can't tell if it is the hardware or the software.
...
I did not update my Raspberry Pi blog again today, that project is still on hiatus.
...
I kept my Raspberry Pi on all night with no Internet connection again. I used the device today to finish audio conversion from yesterday and upload the data, along with doing further conversion. Internet on the Raspberry Pi is very slow, the upload speed doesn't exceed 70 kilobits/second, so it takes nearly half an hour to upload less than 50 megabytes.
...
I kept my Raspberry Pi on all night with no Internet connection again. I used the device today to attribute audio. I have noted that LXDE is a bad looking desktop environment (flat design) but it has extremely high efficiency when compared to the heaviest Linux DE (GNOME) I accidentally opened 60+ image files at once, and wasn't able to close any of them until all of them loaded. It only used less than 200 megabytes of RAM for this, and unlike Ubuntu, it didn't use up all my memory and take the system down, I still had over 7500 megabytes to spare (both devices have the same amount of RAM, although the Raspberry Pi requires over 40x less RAM for most tasks)
...
I kept my Raspberry Pi on all night with no Internet connection again. I used the device today to attribute audio again today, finishing the second batch of the month.
...
- [ ] Can ProtonDrive work on the old web browser that comes with the Raspberry Pi (I would be really surprised if it did, as even GitHub doesn't work on the Raspberry Pi's default web browser) (I am still procrastinating on this task)

- [ ] Other/unlisted

I finally got to updating my Raspberry Pi blog today. I have been intending to change the banner image for a while, but haven't gotten to it.
...
I kept my Raspberry Pi on all night with no Internet connection again. I used the device today to convert audio today, but not add metadata to it yet.
...
These tasks are very easy, I have just been procrastinating on them.
...
I kept my Raspberry Pi on all night with no Internet connection again. I did not use the device today, but I kept it running it running with the screen off.
...
I did not update my Raspberry Pi blog again today. I didn't know it at the time, but this would go on for a long time, and later stress me out significantly.
...
I kept my Raspberry Pi on all night with no Internet connection again. I did not use the device today, but I kept it running it running with the screen off. In the future, I will need to modify entries April 30st to May 1st to include whether I even turned the screen on. I have it written down, but it is hard to navigate.

The Raspberry Pi has been running continuously since 2022 Tuesday April 19th at 8:12 pm. I am going to leave it running until noted otherwise. Just so that I can sleep at night, I turn the monitors off, but not the Pi itself.

Current uptime: 11 days
...
I kept my Raspberry Pi on all night with no Internet connection again. I did not use the device today, but I kept it running it running with the screen off. In the future, I will need to modify entries April 30st to May 2nd to include whether I even turned the screen on. I have it written down, but it is hard to navigate.

The Raspberry Pi has been running continuously since 2022 Tuesday April 19th at 8:12 pm. I am going to leave it running until noted otherwise. Just so that I can sleep at night, I turn the monitors off, but not the Pi itself.

Current uptime: 12 days
...
I kept my Raspberry Pi on all night with no Internet connection again. I did not use the device today, but I kept it running it running with the screen off. In the future, I will need to modify entries April 30st to May 3rd to include whether I even turned the screen on. I have it written down, but it is hard to navigate.

The Raspberry Pi has been running continuously since 2022 Tuesday April 19th at 8:12 pm. I am going to leave it running until noted otherwise. Just so that I can sleep at night, I turn the monitors off, but not the Pi itself.

Current uptime: 13 days
...
I kept my Raspberry Pi on all night with no Internet connection again. I did not use the device today, but I kept it running it running with the screen off. In the future, I will need to modify entries April 30st to May 4th to include whether I even turned the screen on. I have it written down, but it is hard to navigate.

The Raspberry Pi has been running continuously since 2022 Tuesday April 19th at 8:12 pm. I am going to leave it running until noted otherwise. Just so that I can sleep at night, I turn the monitors off, but not the Pi itself.

Current uptime: 14 days
...
I kept my Raspberry Pi on all night with no Internet connection again. I did not use the device today, but I kept it running it running with the screen off. In the future, I will need to modify entries April 30st to May 5th to include whether I even turned the screen on. I have it written down, but it is hard to navigate.

The Raspberry Pi has been running continuously since 2022 Tuesday April 19th at 8:12 pm. I am going to leave it running until noted otherwise. Just so that I can sleep at night, I turn the monitors off, but not the Pi itself.

Current uptime: 15 days
...
I kept my Raspberry Pi on all night with no Internet connection again. I did not use the device today, but I kept it running it running with the screen off. In the future, I will need to modify entries April 30th to May 6th to include whether I even turned the screen on. I have it written down, but it is hard to navigate.
...
I kept my Raspberry Pi on all night with no Internet connection again. I did not use the device today, but I kept it running it running with the screen off. In the future, I will need to modify entries April 30th to May 7th to include whether I even turned the screen on. I have it written down, but it is hard to navigate.

The Raspberry Pi has been running continuously since 2022 Tuesday April 19th at 8:12 pm. I am going to leave it running until noted otherwise. Just so that I can sleep at night, I turn the monitors off, but not the Pi itself.

Current uptime: 17 days
...
I kept my Raspberry Pi on all night with no Internet connection again. I did not use the device today, but I kept it running it running with the screen off. In the future, I will need to modify entries April 30th to May 8th to include whether I even turned the screen on. I have it written down, but it is hard to navigate.

The Raspberry Pi has been running continuously since 2022 Tuesday April 19th at 8:12 pm. I am going to leave it running until noted otherwise. Just so that I can sleep at night, I turn the monitors off, but not the Pi itself.

Current uptime: 18 days
...
I kept my Raspberry Pi on all night with no Internet connection again. I did not use the device today, but I kept it running it running with the screen off. In the future, I will need to modify entries April 30th to May 9th to include whether I even turned the screen on. I have it written down, but it is hard to navigate.

The Raspberry Pi has been running continuously since 2022 Tuesday April 19th at 8:12 pm. I am going to leave it running until noted otherwise. Just so that I can sleep at night, I turn the monitors off, but not the Pi itself.

Current uptime: 19 days
...
I kept my Raspberry Pi on all night with no Internet connection again. I did not use the device today, but I kept it running it running with the screen off. In the future, I will need to modify entries April 30th to May 10th to include whether I even turned the screen on. I have it written down, but it is hard to navigate.

The Raspberry Pi has been running continuously since 2022 Tuesday April 19th at 8:12 pm. I am going to leave it running until noted otherwise. Just so that I can sleep at night, I turn the monitors off, but not the Pi itself.

Current uptime: 20 days
...
I kept my Raspberry Pi on all night with no Internet connection again. I did not use the device today, but I kept it running it running with the screen off. In the future, I will need to modify entries April 30th to May 11th to include whether I even turned the screen on. I have it written down, but it is hard to navigate.

The Raspberry Pi has been running continuously since 2022 Tuesday April 19th at 8:12 pm. I am going to leave it running until noted otherwise. Just so that I can sleep at night, I turn the monitors off, but not the Pi itself.

Current uptime: 21 days (3 weeks, 0 days)
...
I kept my Raspberry Pi on all night with no Internet connection again. I did not use the device today, but I kept it running it running with the screen off. In the future, I will need to modify entries April 30th to May 12th to include whether I even turned the screen on. I have it written down, but it is hard to navigate.

The Raspberry Pi has been running continuously since 2022 Tuesday April 19th at 8:12 pm. I am going to leave it running until noted otherwise. Just so that I can sleep at night, I turn the monitors off, but not the Pi itself.

Current uptime: 22 days (3 weeks, 1 day)
...
I kept my Raspberry Pi on all night with no Internet connection again. I did not use the device today, but I kept it running it running with the screen off. In the future, I will need to modify entries April 30th to May 13th to include whether I even turned the screen on. I have it written down, but it is hard to navigate.

The Raspberry Pi has been running continuously since 2022 Tuesday April 19th at 8:12 pm. I am going to leave it running until noted otherwise. Just so that I can sleep at night, I turn the monitors off, but not the Pi itself.

Current uptime: 32 days (3 weeks, 2 days)
...
I kept my Raspberry Pi on all night with no Internet connection again. I did not use the device today, but I kept it running it running with the screen off. In the future, I will need to modify entries April 30th to May 14th to include whether I even turned the screen on. I have it written down, but it is hard to navigate.

The Raspberry Pi has been running continuously since 2022 Tuesday April 19th at 8:12 pm. I am going to leave it running until noted otherwise. Just so that I can sleep at night, I turn the monitors off, but not the Pi itself.

Current uptime: 24 days (3 weeks, 3 days)
...
I kept my Raspberry Pi on all night with no Internet connection again. I did not use the device today, but I kept it running it running with the screen off. In the future, I will need to modify entries April 30th to May 15th to include whether I even turned the screen on. I have it written down, but it is hard to navigate.

The Raspberry Pi has been running continuously since 2022 Tuesday April 19th at 8:12 pm. I am going to leave it running until noted otherwise. Just so that I can sleep at night, I turn the monitors off, but not the Pi itself.

Current uptime: 25 days (3 weeks, 4 days)
...
I kept my Raspberry Pi on all night with no Internet connection again. I did not use the device today, but I kept it running it running with the screen off. In the future, I will need to modify entries April 30th to May 16th to include whether I even turned the screen on. I have it written down, but it is hard to navigate.

The Raspberry Pi has been running continuously since 2022 Tuesday April 19th at 8:12 pm. I am going to leave it running until noted otherwise. Just so that I can sleep at night, I turn the monitors off, but not the Pi itself.

Current uptime: 26 days (3 weeks, 5 days)
...
I kept my Raspberry Pi on all night with no Internet connection again. I did not use the device today, but I kept it running it running with the screen off. In the future, I will need to modify entries April 30th to May 17th to include whether I even turned the screen on. I have it written down, but it is hard to navigate.

The Raspberry Pi has been running continuously since 2022 Tuesday April 19th at 8:12 pm. I am going to leave it running until noted otherwise. Just so that I can sleep at night, I turn the monitors off, but not the Pi itself.

Current uptime: 27 days (3 weeks, 6 days)
...
I kept my Raspberry Pi on all night with no Internet connection again. I did not use the device today, but I kept it running it running with the screen off. In the future, I will need to modify entries April 30th to May 18th to include whether I even turned the screen on. I have it written down, but it is hard to navigate.

The Raspberry Pi has been running continuously since 2022 Tuesday April 19th at 8:12 pm. I am going to leave it running until noted otherwise. Just so that I can sleep at night, I turn the monitors off, but not the Pi itself.

Current uptime: 28 days (4 weeks, 0 days)
...
I kept my Raspberry Pi on all night with no Internet connection again. I did not use the device today, but I kept it running it running with the screen off. In the future, I will need to modify entries April 30th to May 19th to include whether I even turned the screen on. I have it written down, but it is hard to navigate.

The Raspberry Pi has been running continuously since 2022 Tuesday April 19th at 8:12 pm. I am going to leave it running until noted otherwise. Just so that I can sleep at night, I turn the monitors off, but not the Pi itself.

Current uptime: 29 days (4 weeks, 1 day)
...
I kept my Raspberry Pi on all night with no Internet connection again. I did not use the device today, but I kept it running it running with the screen off. In the future, I will need to modify entries April 30th to May 20th to include whether I even turned the screen on. I have it written down, but it is hard to navigate.

The Raspberry Pi has been running continuously since 2022 Tuesday April 19th at 8:12 pm. I am going to leave it running until noted otherwise. Just so that I can sleep at night, I turn the monitors off, but not the Pi itself.

Current uptime: 30 days (4 weeks, 2 days)
...
Scarlet oven
SD clone
When I will add metadata
ProtonDrive
!-->

- [x] Nothing new learnt today

I kept my Raspberry Pi on all night with no Internet connection again. I did not use the device today, but I kept it running it running with the screen off. I turned the screen off to get some time data for updating the RPi blog today.

The Raspberry Pi has been running continuously since 2022 Tuesday April 19th at 8:12 pm. I am going to leave it running until noted otherwise. Just so that I can sleep at night, I turn the monitors off, but not the Pi itself.

Current uptime: 31 days (4 weeks, 3 days)

I plan to get the files off the Raspberry Pi eventually, but not today.

There are some things I still intend to test:

- [x] Can ProtonDrive work on the old web browser that comes with the Raspberry Pi (I finally tested it on 2022 May 21st, I forgot to mention that I previously got ProtonMail to work, and in conclusion, I was able to get ProtonDrive to work)

- [ ] Other/unlisted

I finally updated my Raspberry Pi blog today after a 23 day hiatus. It has been really stressing me out being so far behind, and I still have other projects to catch up on. Hopefully now I can keep this one under control.
...
I kept my Raspberry Pi on all night with no Internet connection again. I did not use the device today, but I kept it running it running with the screen off. I did not turn the screen on today, I was just too busy.

The Raspberry Pi has been running continuously since 2022 Tuesday April 19th at 8:12 pm. I am going to leave it running until noted otherwise. Just so that I can sleep at night, I turn the monitors off, but not the Pi itself.

Current uptime: 32 days (4 weeks, 4 days)
...
I updated my Raspberry Pi blog again today, this is the entry from a day after the end of a nightmarish 23 day hiatus.
...
There was a strong storm that went by this evening, there was a power flicker, but no power outage. The Raspberry Pi was unaffected.

The Raspberry Pi has been running continuously since 2022 Tuesday April 19th at 8:12 pm. I am going to leave it running until noted otherwise. Just so that I can sleep at night, I turn the monitors off, but not the Pi itself.

Current uptime: 33 days (4 weeks, 5 days)
...
I updated my Raspberry Pi blog again today, I hope to keep doing this consistently.
...
Current uptime: 34 days (4 weeks, 6 days)
...
Current uptime: 35 days (5 weeks, 0 days)
...
Current uptime: 36 days (5 weeks, 1 day)
...
There have been frequent storms lately, and I can't come back to this blog later today, so if a storm knocks the power out, I will write about it tomorrow.

The Raspberry Pi has been running continuously since 2022 Tuesday April 19th at 8:12 pm. I am going to leave it running until noted otherwise. Just so that I can sleep at night, I turn the monitors off, but not the Pi itself.

Current uptime: 37 days (5 weeks, 2 days)

I plan to get the files off the Raspberry Pi eventually, but not today. I am currently unable to do that if I wanted to, as the SD card reader in my laptop is damaged, and I don't have my SD card dongle with me at the moment.
...
There have been frequent storms lately, and I can't come back to this blog later today, so if a storm knocks the power out, I will write about it tomorrow. There were no outages for 2022 May 27th, but another storm is expected today.

The Raspberry Pi has been running continuously since 2022 Tuesday April 19th at 8:12 pm. I am going to leave it running until noted otherwise. Just so that I can sleep at night, I turn the monitors off, but not the Pi itself.

Current uptime: 38 days (5 weeks, 3 days)
...
I kept my Raspberry Pi on all night with no Internet connection again. I did not use the device today, but I kept it running it running with the screen off. I did not turn the screen on today, I was just too busy. I am starting to see this as being the new hiatus method for my Raspberry Pi usage.

There have been frequent storms lately, and I can't come back to this blog later today, so if a storm knocks the power out, I will write about it tomorrow. There were no outages for 2022 May 28th, but yet another storm is expected today. It is still spring here, so it isn't too uncommon.

The Raspberry Pi has been running continuously since 2022 Tuesday April 19th at 8:12 pm. I am going to leave it running until noted otherwise. Just so that I can sleep at night, I turn the monitors off, but not the Pi itself.

Current uptime: 39 days (5 weeks, 4 days)
...
There have been frequent storms lately, and I can't come back to this blog later today, so if a storm knocks the power out, I will write about it tomorrow. There were no outages for 2022 May 29th, and there are no known storms for today.

The Raspberry Pi has been running continuously since 2022 Tuesday April 19th at 8:12 pm. I am going to leave it running until noted otherwise. Just so that I can sleep at night, I turn the monitors off, but not the Pi itself.

Current uptime: 40 days (5 weeks, 5 days)
...
Current uptime: 41 days (5 weeks, 6 days)
...
Current uptime: 42 days (6 weeks, 0 days)
...
I updated my Raspberry Pi blog again today, I hope to keep doing this consistently. I almost forgot today.
...
I did not boot up/use my Raspberry Pi today.
...
I did not boot up/use my Raspberry Pi again today.
...
> https://raspberrypi.stackexchange.com/questions/325/is-the-raspberry-pi-suitable-for-running-continuously-24-7#352 [Is it OK to leave the Raspberry Pi on 24/7]
...
_Current research focus(s):_ `Advanced screenshots` `Video recording` `Installing another web browser` `Ruby programming` `Misc`
...
**File version:** `1 (Sunday, 2022 June 5th at 8:43 pm PST)`
